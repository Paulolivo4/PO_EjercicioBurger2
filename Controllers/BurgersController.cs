...
namespace PO_EjercicioBurger2.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(PO_EjercicioBurger2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurgerId,BurgerName,WithCheese,Price,PriceCeiling")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurgerId,BurgerName,WithCheese,Price,PriceCeiling")] Burger burger)
        {
